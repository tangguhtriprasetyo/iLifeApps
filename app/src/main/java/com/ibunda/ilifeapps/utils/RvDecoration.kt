...
class RvDecoration : RecyclerView.ItemDecoration() {
    ...
    private val colorActive = Color.parseColor("#F8F8F8")
    private val colorInactive = Color.parseColor("#33000000")
    ...
    override fun onDrawOver(c: Canvas, parent: RecyclerView, state: RecyclerView.State) {
        ...
        val indicatorPosY = parent.height - mIndicatorHeight / 1.5f
